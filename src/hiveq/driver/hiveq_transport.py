"""``hiveq.driver.hiveq_transport`` — PLATFORM-ONLY IMPORT STUB.
...
class HiveQTransport:
    """Platform-only: constructing this locally raises."""

    def __init__(self, *args, **kwargs):
        _unavailable("hiveq.driver.hiveq_transport.HiveQTransport()")


__all__ = ['HiveQTransport']
