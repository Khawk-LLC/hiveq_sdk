...
RULES = [
    ...
    (("options_signals_strategy", "zerodte_custom_data", "zerodte_signal_strategy", "signal_dynamic_data"),
     "baseline_t26_option_filters.py,baseline_t40_option_order_fill.py,long_running_t73_multileg_options.py,baseline_t36_custom_csv_routing.py,baseline_t37_hosted_signals.py",
     "combined option and custom/hosted-signal routing"),
    (("option", "0dte", "snap", "strike", "expiration", "iron_condor", "zerodte", "all_filters"),
     "baseline_t26_option_filters.py,baseline_t40_option_order_fill.py,long_running_t73_multileg_options.py",
